 ...
 */
export declare enum RequestErrorProblemType {
    /**
...
export declare enum GetRequestErrorType {
    /**
...
export declare enum ChangesRequestErrorType {
    /**
 ...
 */
export type PatchObject<T> = Partial<T> | {
    [K in ExtendedJSONPointer]: any;
};
export type SetResponse<T extends object, Args> = Args extends SetArguments<T> ? {
    ...
    notCreated: Args["create"] extends object ? {
        [K in keyof Args["create"]]?: SetError;
    } | null : null;
    /**
    ...
    notUpdated: Args["update"] extends object ? {
        [K in keyof Args["update"]]?: SetError;
    } | null : null;
    /**
     * A map of the `T` id to a SetError object for each record that
 ...
 */
export declare enum SetErrorType {
    /**
...
export declare enum SetRequestErrorType {
    /**
...
export declare enum CopySetErrorType {
    /**
...
export declare enum CopyRequestErrorType {
    /**
...
export declare enum QueryRequestErrorType {
    /**
...
export declare enum QueryChangesRequestErrorType {
    /**
...
export declare enum BlobCopySetErrorType {
    /**
...
export declare enum EventSourceCloseAfterType {
    /**
