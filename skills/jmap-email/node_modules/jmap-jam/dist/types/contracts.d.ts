...
import type { Email, EmailCreate, EmailFilterCondition, EmailImport, EmailSubmission, EmailSubmissionCreate, EmailSubmissionFilterCondition, GetValueFromHeaderKey, HeaderFieldKey, Identity, IdentityCreate, Mailbox, MailboxCreate, MailboxFilterCondition, SearchSnippet, Thread, VacationResponse, VacationResponseCreate } from "./jmap-mail.ts";
import type { BlobCopyArguments, BlobCopyResponse, ChangesArguments, ChangesResponse, CopyArguments, CopyResponse, FilterCondition, FilterOperator, GetArguments, GetResponse, ID, Request as JMAPRequest, Response as JMAPResponse, ProblemDetails, PushSubscription, PushSubscriptionCreate, QueryArguments, QueryChangesArguments, QueryChangesResponse, QueryResponse, SetArguments, SetError, SetResponse } from "./jmap.ts";
...
export type Responses<A> = HasAllKeysOfRelated<Requests, {
    ...
    "PushSubscription/set": Omit<SetResponse<PushSubscription, A>, "accountId" | "oldState" | "newState">;
...
export type GetEmailResponse<Args> = Args extends GetEmailArguments ? {
    accountId: ID;
    state: string;
    list: ReadonlyArray<Args["properties"] extends Array<infer P extends string> ? {
        [Key in P]: Key extends HeaderFieldKey ? GetValueFromHeaderKey<Key> : Key extends keyof Email ? Email[Key] : never;
    } : Email>;
